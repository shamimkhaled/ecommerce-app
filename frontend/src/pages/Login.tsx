    ...
    <div className="container-custom py-10 sm:py-20 flex items-center justify-center">
      ...
      >
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h1 className="text-3xl sm:text-5xl font-extrabold mb-4 tracking-tight">Welcome Back</h1>
          <p className="text-slate-500 dark:text-slate-400 text-[11px] font-bold uppercase tracking-[0.2em]">Login to your ElectroHub account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8 sm:space-y-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between px-1">
              ...
              <Link to="/forgot-password" className="text-[10px] font-bold text-brand-600 hover:text-brand-700 uppercase tracking-[0.2em]">Forgot?</Link>
            </div>
            <div className="relative">
              <input
